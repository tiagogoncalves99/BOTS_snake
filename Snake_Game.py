...
Game implementation.
Taken from: https://github.com/TheAILearner/Training-Snake-Game-With-Genetic-Algorithm/blob/master/Snake_Game.py
Only changed the dimensions of the snake's playground from 50x50 to 20x20
